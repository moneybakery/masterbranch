...
uint256 hashGenesisBlock("0x59255359ca750158d97b87a175b312876092d2c3ef82eb683a4b2946df465941");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 6) // no block reward within the first 3 days
        nSubsidy = 0;
...
static const int64 nTargetSpacing = 300; // Branch: 15 seconds
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2fdfa125588e5d9eb8beec46751403c1bf791aa4e3b8d015d13bf237e880dc43");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Branch is the revolutionary project";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1502845662;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 388614819;

        if (fTestNet)
        {
            block.nTime    = 1502826062;
            block.nNonce   = 386989531;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5581a2b3e9f677d6e378eaa74f58c0c492919a7cd60c3eb25578a6ada0a0889e"));
